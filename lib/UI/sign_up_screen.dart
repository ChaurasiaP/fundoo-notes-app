...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  void _createAccount() async {
    ...
    if (uName == "" || password == "" || cnfPassword == "") {
      ...
      _showSnackBar(
          "Password and Confirm Password do not match", Colors.redAccent);
    } else {
      try {
  ...
  _signUpPageDecoration(String label, String hint) => InputDecoration(
              ...
              child: Column(
                children: [
                  ...
                  TextField(
                    ...
                    decoration:
                        _signUpPageDecoration("Email", "Enter Your Email"),
                  ),
                  ...
                  TextField(
                    ...
                    obscuringCharacter: '*',
                    decoration:
                        _signUpPageDecoration("Password", "enter new password"),
                  ),
                  ...
                  TextField(
                    ...
                    obscureText: true,
                    obscuringCharacter: '*',
                    decoration: _signUpPageDecoration(
